...
<body class="apply-page">
  ...
  <header class="navbar">
    ...
    <!--Left section of the navbar for styling-->
    <div class="nav-left">
      <!--Company Logo-->
    ...
    <ul class="nav-links">
      ...
      <li><a href="https://github.com/105406263/project1" target="_blank">GitHub</a></li>
    </ul>
  ...
  <footer>
    <p>© 2025 TechEmpower. All rights reserved. |
       <!-- Jira Project Link -->
      <a href="https://soadmahdi9.atlassian.net/jira/software/projects/TWP/boards/2" target="_blank">View our Jira
        Project</a>
    </p>
  </footer>
</body>
